...
$sql = "SELECT * FROM pregnancy_progress";
                ...
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-city"></i><span>Checkups</span></a>
                        <ul class="ml-menu">
                            ...
                            <li><a href="checkup.php">View Checkup</a></li>
                        </ul>
                    </li>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                    <button onclick="window.location.href='addpregnancyprogress.php'" class="btn btn-primary btn-round">Add progress</button></td>
                    </div>
                    <div class="body">
                        <table class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td  onclick="window.location.href='editpregnancyprogress.php?id=<?php echo $row['progress_id']; ?>'"><?php echo $row["progress_due_date"]?></td>
                                    <td  onclick="window.location.href='editpregnancyprogress.php?id=<?php echo $row['progress_id']; ?>'"><?php echo $row["progress_doctor_description"]?></td>
                                    <td><button onclick="window.location.href='editpregnancyprogress.php?id=<?php echo $row['progress_id']; ?>'" name="submit" class="btn btn-warning btn-round">Edit</button></td>
                                    <td><button onclick="window.location.href='deletepregnancyprogress.php?id=<?php echo $row['progress_id']; ?>'" class="btn btn-danger btn-round">Delete</button></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
                        </table>
