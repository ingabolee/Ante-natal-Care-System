                    ...
                    <div class="body">
                        <table class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                $sql = "SELECT * FROM pregnancy_progress WHERE progress_checkup_id='$checkup_id'";
                                ...
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td  ><?php echo $row["progress_due_date"]?></td>
                                    <td  ><?php echo $row["progress_doctor_description"]?></td>
                                    <td><button onclick="window.location.href='addpayment.php?id=<?php echo $row['progress_id']; ?>'" name="submit" class="btn btn-primary btn-round">Pay</button></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
                        </table>
