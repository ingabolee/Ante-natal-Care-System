...
if(isset($_POST['submit'])){
    ...
    if($login_password == $cpassword){
        ...
        if ($result -> num_rows > 0){
            ...
            $sql = "SELECT * FROM doctor WHERE doctor_contact = '$doctor_contact'";
            $result = mysqli_query($conn, $sql);
            if ($result -> num_rows > 0){
                ...
                //doctor table
                $sql = "INSERT INTO doctor (doctor_first_name, doctor_last_name, doctor_contact, doctor_login_id) 
                VALUES ('$doctor_first_name', '$doctor_last_name', '$doctor_contact', '$login_id')";
                ...
                <form class="form" method="POST" action="">
                    ...
                    <div class="content">                                                
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="First Name" name="doctor_first_name" required="required">
                            <span class="input-group-addon">
                                <i class="zmdi zmdi-account-circle"></i>
                            </span>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Last Name" name="doctor_last_name" required="required">
                            <span class="input-group-addon">
                                <i class="zmdi zmdi-account-circle"></i>
                            </span>
                        </div>
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" placeholder="contact" name="doctor_contact" required="required">
                            <span class="input-group-addon">
                                <i class="zmdi zmdi-account-circle"></i>
                            </span>
                        </div>
                    ...
                    <div class="footer text-center">
                        ...
                        <br>
                        <small>Sign Up as a Mother   <a href="signupmother.php" class="link">      Sign Up(Mother)</a></small>
                    </div>
                </form>
            </div>
        </div>
